...
contexts_LibraryBorrowMachine.prototype = {
	...
	,finishButtons__waitForFinishClick: function() {
		this.finishButtons.onFinishWithoutReceiptClicked($bind(this,this.screen__displayDontForgetLibraryCard),{ fileName : "LibraryBorrowMachine.hx", lineNumber : 229, className : "contexts.LibraryBorrowMachine", methodName : "finishButtons__waitForFinishClick"});
		this.finishButtons.onFinishWithReceiptClicked($bind(this,this.printer__printReceipt),{ fileName : "LibraryBorrowMachine.hx", lineNumber : 230, className : "contexts.LibraryBorrowMachine", methodName : "finishButtons__waitForFinishClick"});
	}
	,keypad__waitForEnterPin: function() {
		this.keypad.onPinCodeEntered($bind(this,this.cardReader__validatePin),{ fileName : "LibraryBorrowMachine.hx", lineNumber : 238, className : "contexts.LibraryBorrowMachine", methodName : "keypad__waitForEnterPin"});
	}
